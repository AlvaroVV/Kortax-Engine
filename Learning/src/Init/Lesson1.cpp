...
#include "Examples\Projection_Simple.h"

//----------- Book Examples -----
#include "Examples\Book\C6_SimpleLight.h"
#include "Examples\Book\C6_Blending.h"
#include "Examples\Book\C7_SimpleBitmap.h"
#include "Examples\Book\C8_Terrain.h"
	...
	GLfloat w_Height ; //Default height
	GLfloat w_Width ; //Default width
	...
	*/
	...
	/*
	* Entry Point.
	* @param hInstance. Handler to application instance.
	* @param hPrevInstance. Deprecated so always null.
	* @param lpCmdLine. Pointer to string to cmd line
	* @param nCmdShow. Determines how the application is displayed.
	*/
			...
			else
			{
				if (active)
				{
					...
					else
					{
						...
						glProgram->processInput(keys,mouseX,mouseY);
					}
				}
